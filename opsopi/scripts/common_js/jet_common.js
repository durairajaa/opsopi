    ...
    function extract_result(response) {
        ...
        if (resp_elem_wm.find(".iKMVVd").length > 0) {
            ...
            try {
                ...
                console.log("imag_class_list")
                console.log(imag_class_list);   
                if(imag_class_list.indexOf("sc-cFlXAS")>-1){
                    console.log("found div with image")
                ...
                console.log($(firstResult).find(".fIHTxs:eq(1) div:eq(0)"));
                console.log($(firstResult).find(".fIHTxs:eq(1) div:eq(0)")[0].style);
...
function get_property_from_rule_list(style_property,rules_list){
  var rule_with_prop =  rules_list.filter(function(rule){
    ...
    console.log("rule with prop");
    console.log(rule_with_prop);
